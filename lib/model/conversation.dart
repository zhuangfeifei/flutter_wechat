...
class Conversation {
  ...
  bool isAvatarFromNet(){
    return this.avatar.indexOf('http') == 0 ? true : false;
  }
}

class ConverstaionPageData {
  final Device device;
  final List<Conversation> conversations;

  const ConverstaionPageData({
    this.device,
    this.conversations,
  });

  static mock(){
    return ConverstaionPageData(device: Device.MAC, conversations: mockConversations);
  }
